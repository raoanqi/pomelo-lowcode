...
<template>
  <div class="low-code-generator">
    ...
    <div class="container">
      ...
      <!-- 中间画布 -->
      <Canvas :components="canvasComponents" :selected-component="selectedComponent"
        @select-component="handleSelectComponent" @update-component="handleUpdateComponent" />

      <!-- 右侧配置面板 -->
      <ConfigPanel :selected-component="selectedComponent" @update-component="handleUpdateComponent" />
    </div>
    ...
    <footer class="footer">
      <p>
        ...
        联系邮箱：<a href="mailto:1518014096@qq.com">1518014096@qq.com</a>
      </p>
    </footer>
  </div>
</template>
