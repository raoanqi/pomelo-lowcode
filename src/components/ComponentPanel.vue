...
import { ElButton, ElInput, ElSelect, ElSwitch, ElRadio, ElCheckbox, ElDatePicker, ElTimePicker, ElSlider, ElRate } from 'element-plus';
...
const categories = [
  ...
  { name: '表单组件', components: ['el-select', 'el-switch', 'el-radio-group', 'el-checkbox-group', 'el-date-picker', 'el-slider', 'el-rate'] }
];
  ...
  <div class="component-panel">
    ...
    <div v-if="activePanel === 'components'" class="standard-components">
      ...
      <div class="component-list">
        <draggable :list="filteredComponents" :group="{ name: 'components', pull: 'clone', put: false }" item-key="type"
          :clone="cloneComponent" @dragstart="onDragStart" @dragend="onDragEnd" @add="onDragAdd" :sort="false">
