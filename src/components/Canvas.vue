...
import { ElButton, ElInput, ElSelect, ElOption, ElSwitch, ElRadio, ElRadioGroup, ElCheckbox, ElCheckboxGroup, ElDatePicker, ElTimePicker, ElSlider, ElRate } from 'element-plus';
...
<template>
  <div class="canvas-container">
    <div class="canvas-header">
      ...
      <div class="canvas-actions">
        <el-tooltip content="导出当前画布内容为JSON" placement="top">
          <el-button @click="exportToJSON" type="success" size="small">
            <el-icon>
              <Download />
            </el-icon>
            导出JSON
        ...
        <el-tooltip content="保存为我的组件" placement="top">
          <el-button @click="saveAsComponent" type="primary" size="small">
            <el-icon>
              <Star />
            </el-icon>
            保存为我的组件
    ...
    <div class="canvas">
      <draggable v-model="componentList" group="components" item-key="id" class="canvas-content"
        @end="handlePositionUpdate" @change="(e) => console.log('Draggable change event:', e)"
        @add="(e) => console.log('Draggable add event:', e)">
        <template #item="{ element }">
          <div v-if="element && element.type" class="canvas-item" :class="{ 'selected': isSelected(element) }"
